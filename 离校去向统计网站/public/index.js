...
//添加请求
addEvent(document.getElementById('infom'),"submit", function(event) {
    forbiddenEvent(event);
    //获取表单提交数据
    var form = document.getElementById('infom');
    var info = {
        name: '松松',
        class:'电信1701',
        grade: 'test@qq.com',
    ...
    //POST表单json数据到服务器
    getData("POST", "http://localhost:3030/contacts", JSON.stringify(info), function() {
