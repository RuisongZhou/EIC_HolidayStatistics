...
addEvent(document.getElementById('get'),"click", function(event) {
    ...
    getData("PUT", "http://118.190.207.113:3030/repassword", JSON.stringify(info), function() {
...
addEvent(document.getElementById('login'),"submit", function(event) {
    ...
    //POST表单json数据到服务器
    getData("POST", "http://118.190.207.113:3030/repassword", JSON.stringify(info), function() {
        if (xmlhttp.readyState == 4) {
            if (xmlhttp.status == 200) {
